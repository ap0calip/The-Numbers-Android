            ...
            BoxWithConstraints(modifier = Modifier.fillMaxSize()) {
                ...
                if (isLandscape) {
                    Column(
                        ...
                        Row(
                            ...
                            Column(
                                ...
                                MainExerciseContent(uiState = uiState, viewModel = viewModel)
                            ...
                            if (showBottomControls) {
                                ...
                                // Right side: Keypad fixed to the right of the screen
                                KeypadControlsCard(
                    ...
                    Column(
                        ...
                        // Fixed Top Action Bar in portrait mode
                        TopActionBar(
                            uiState = uiState,
                            onOpenDrawer = { scope.launch { drawerState.open() } },
                            onToggleSound = { viewModel.toggleSound() }
                        ...
                        // Scrollable middle exercise area
                        Column(
                            modifier = Modifier
                                .fillMaxWidth()
                                .weight(1f)
                        ...
                        // Fixed bottom controls in portrait mode
                        if (showBottomControls) {
                            KeypadControlsCard(
                                onClearPressed = { viewModel.onClearPressed() },
                                onDigitPressed = { digit -> viewModel.onDigitPressed(digit) },
...
@Composable
private fun KeypadControlsCard(
    onClearPressed: () -> Unit,
...
@Composable
private fun MainExerciseContent(
    uiState: MathUiState,
    viewModel: MathViewModel,
    modifier: Modifier = Modifier
) {
